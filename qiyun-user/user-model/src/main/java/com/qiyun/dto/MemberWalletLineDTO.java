...
public class MemberWalletLineDTO implements Serializable {
    ...
    public void setWalletTypeStr(String walletTypeStr) {
        this.walletTypeStr = walletTypeStr;
    }
    ...
    public String toString() {
        ...
        sb.append(", remark=").append(transTypeStr);
        sb.append(", remark=").append(walletTypeStr);
        sb.append(", remark=").append(lotteryTypeStr);
