...
public class WalletTransType extends IntegerBeanLabelItem {
	...
	public static final WalletTransType PRESENT_REMOVE = new WalletTransType("彩金卡使用", -1001); // 独立扣款科目，负数值存为正
	...
	public static final WalletTransType LL_QUICK= new WalletTransType("快捷支付充值", 2072); //连连快捷
	public static final WalletTransType YF_WXSCAN= new WalletTransType("微信扫码充值", 2073); //引付微信扫码
	public static final WalletTransType YF_QQSCAN= new WalletTransType("QQ扫码充值", 2074); //引付QQ扫码
	public static final WalletTransType YF_WY= new WalletTransType("网银充值", 2075); //引付网银
	public static final WalletTransType XYF_ZFB= new WalletTransType("星驿付支付宝充值", 2076); //星驿付支付宝
	public static final WalletTransType XYF_WX= new WalletTransType("星驿付微信充值", 2077); //星驿付微信
	public static final WalletTransType RECHARGE_FIX= new WalletTransType("充值补单", 2078); //充值补单
	...
	public static final WalletTransType GIVE_REMOVE= new WalletTransType("消费赠送扣除", 44);
	public static final WalletTransType GOLD_REMOVE= new WalletTransType("佣金扣除", 45);
	...
	static {
		...
		outTypeList.add(WalletTransType.GIVE_REMOVE);
		outTypeList.add(WalletTransType.GOLD_REMOVE);
		//充值的类型
		chargeTypeList.add(LL_QUICK);
		chargeTypeList.add(XY_WX);
		...
		chargeTypeList.add(WalletTransType.YF_QQSCAN);
		chargeTypeList.add(WalletTransType.YF_WXSCAN);
		chargeTypeList.add(WalletTransType.YF_WY);
		chargeTypeList.add(WalletTransType.XYF_WX);
		chargeTypeList.add(WalletTransType.XYF_ZFB);
		chargeTypeList.add(WalletTransType.RECHARGE_FIX);
		//消费的类型
		...
		// 其他
		otherList.add(RETURN_RED_PACKET);
