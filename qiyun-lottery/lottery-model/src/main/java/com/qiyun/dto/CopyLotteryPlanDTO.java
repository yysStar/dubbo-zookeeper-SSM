...
public class CopyLotteryPlanDTO implements Serializable {
    ...
    private BigDecimal copyLotteryplanAddprize;
    ...
    public BigDecimal getCopyLotteryplanAddprize() {
        return copyLotteryplanAddprize;
    }

    public void setCopyLotteryplanAddprize(BigDecimal copyLotteryplanAddprize) {
