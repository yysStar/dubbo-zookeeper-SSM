...
public class MatchAwardOfRQSPF extends AbstractAward {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8613303600133914728L;
	...
	public boolean checkAwardIsChange(AbstractAward tempAward) {
		MatchAwardOfRQSPF award = (MatchAwardOfRQSPF) tempAward;
		boolean flag = false;
		if (award == null) {
			return flag;
		}
