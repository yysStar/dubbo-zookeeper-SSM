...
public class FbBqcTermBuilder extends AbstractLotteryTermBuider {
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.BQC,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
