...
public class DcSfggTermBuilder extends AbstractLotteryTermBuider {
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.DC_SFGG,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
