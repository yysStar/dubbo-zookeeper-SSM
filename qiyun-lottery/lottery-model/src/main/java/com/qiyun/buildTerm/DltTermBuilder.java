...
public class DltTermBuilder extends AbstractLotteryTermBuider {
    ...
    static {
        ...
        nextOpenDates.put(4, 3);
        nextOpenDates.put(7, 2);
    }
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        for (int i = 1; i <= buildCount; i++) {
            ...
            LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.DLT,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
