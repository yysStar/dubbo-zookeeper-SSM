...
public class Ln11x5TermBuilder extends AbstractLotteryTermBuider {
    final int termNum=83;         //每天N期
    final int openInterval=600;   //每期前隔10分钟
    final int startSaleDelay=-60; //提前60秒开售下期
    final int stopSaleDelay=openInterval-60; //提前 60秒截止
    final String dateFormat="yyyyMMdd";
    final String startTime="08:48:50";
    final LotteryType lotteryType=LotteryType.LN11X5;
