...
public class SX11x5TermBuilder extends AbstractLotteryTermBuider {
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        for (int i = 1; i <= buildCount; i++) {
            ...
            LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.SX11X5,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
