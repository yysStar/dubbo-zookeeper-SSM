...
public class FbJq4TermBuilder extends AbstractLotteryTermBuider {
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.JQC,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
