...
public class SsqTermBuilder extends AbstractLotteryTermBuider {
    ...
    static {
        ...
        nextOpenDates.put(3, 2);
        nextOpenDates.put(5, 3);
    }
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        for (int i = 1; i <= buildCount; i++) {
            ...
            LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.SSQ,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
