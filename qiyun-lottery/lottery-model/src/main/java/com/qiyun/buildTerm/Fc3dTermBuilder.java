...
public class Fc3dTermBuilder extends AbstractLotteryTermBuider {
    ...
    public List<LotteryTerm2> build(String oldTerm, Date oldOpenDateTime, int buildCount) {
        ...
        for (int i = 1; i <= buildCount; i++) {
            ...
            LotteryTerm2 lotteryTerm = createLotteryTerm(LotteryType.FC3D,oldTerm,startDateTime,endDateTime,terminalEndDateTime,openDateTime);
