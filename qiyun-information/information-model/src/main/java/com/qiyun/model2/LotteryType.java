...
public class LotteryType extends IntegerBeanLabelItem {
	...
	static {
		...
		// LOTTERY_PATH.put(SFC, "fbsfc");//胜负�?14�?
		// LOTTERY_PATH.put(SFR9, "fbr9");//胜负�?9
		// LOTTERY_PATH.put(JQC, "fbjq4");//4场进�?
		...
		LOTTERY_PATH.put(JC_ZQ_ALTERNATIVE, "jingcai/ht2c1.shtml");// 竞彩足球2�?1
		LOTTERY_PATH.put(JC_ZQ_SPFHT, "jingcai");// 竞彩足球2�?1
